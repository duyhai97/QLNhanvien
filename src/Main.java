public class Main {
    public static void main(String[] args) {
        ...
        nhanvien[1] = new NhanVienFulltime(2 ,"hai" ,24, 11111, "aaa", 1000000, 500000, 30000000 );
        ...
        nhanvien[4] = new NhanVienFulltime(5 ,"hai" ,24, 11111, "aaa", 1000000, 500000, 50000000 );
        ...
        System.out.println(hai.countSalaryReal());
